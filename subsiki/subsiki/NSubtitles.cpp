...
int Subtitle::Getshour()
{
	return shour;
}

int Subtitle::Getsminute()
{
	return sminute;
}

int Subtitle::Getssecond()
{
	return ssecond;
}

int Subtitle::Getsmsecond()
{
	return smsecond;
}

int Subtitle::Getehour()
{
	return ehour;
}

int Subtitle::Geteminute()
{
	return eminute;
}

int Subtitle::Getesecond()
{
	return esecond;
}

int Subtitle::Getemsecond()
{
	return emsecond;
}
